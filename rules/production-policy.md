...
### 🧪 10. Testing
- [Testing Policy](#7-testing-policy)
  - [7.0 Testing Philosophy](#70-testing-philosophy)
  - [7.1 Test Classification](#71-test-classification)
    - [7.1.1 Unit Tests](#711-unit-tests)
    - [7.1.2 Integration Tests](#712-integration-tests)
    - [7.1.3 System Tests](#713-system-tests)
  - [7.2 Cross-Cutting Policies](#72-cross-cutting-policies-all-languages)
    - [7.2.1 Determinism](#721-determinism)
    - [7.2.2 Test Structure (AAA Pattern)](#722-test-structure-aaa-pattern)
    - [7.2.3 Test Data Isolation](#723-test-data-isolation)
    - [7.2.4 CI/CD Gating](#724-cicd-gating)
    - [7.2.5 Spec Validation in Tests](#725-spec-validation-in-tests)
  - [7.3 Language-Specific Policies](#73-language-specific-policies)
    - [7.3.1 Python Testing Policy](#731-python-testing-policy)
    - [7.3.2 C++ Testing Policy](#732-c-testing-policy)
    - [7.3.3 CUDA / GPU C++ Testing Policy](#733-cuda--gpu-c-testing-policy)
    - [7.3.4 Rust Testing Policy](#734-rust-testing-policy)
    - [7.3.5 Go Testing Policy](#735-go-testing-policy)
    - [7.3.6 TypeScript / JavaScript Testing Policy](#736-typescript--javascript-testing-policy)
    - [7.3.7 Java Testing Policy](#737-java-testing-policy)
  - [7.4 Test Execution Environments](#74-test-execution-environments)
    - [7.4.1 Local Development](#741-local-development)
    - [7.4.2 CI/CD Pipeline](#742-cicd-pipeline)
  - [7.5 Coverage Requirements](#75-coverage-requirements)
    - [7.5.1 Unit Test Coverage](#751-unit-test-coverage)
    - [7.5.2 Integration Test Coverage](#752-integration-test-coverage)
    - [7.5.3 System Test Coverage](#753-system-test-coverage)
  - [7.6 Test Data Management](#76-test-data-management)
    - [7.6.1 Tiny Fixtures (Committed to Git)](#761-tiny-fixtures-committed-to-git)
    - [7.6.2 Small Test Data (Not Committed)](#762-small-test-data-not-committed)
    - [7.6.3 Large Test Data (Immutable Snapshots)](#763-large-test-data-immutable-snapshots)
  - [7.7 Test Maintenance](#77-test-maintenance)
    - [7.7.1 Flaky Test Policy](#771-flaky-test-policy)
    - [7.7.2 Test Debt Tracking](#772-test-debt-tracking)
    - [7.7.3 Deprecated Code Testing](#773-deprecated-code-testing)
  - [7.8 Test-Driven Development (TDD) Guidance](#78-test-driven-development-tdd-guidance)
    - [When to Use TDD](#when-to-use-tdd)
    - [TDD Workflow](#tdd-workflow)
  - [7.9 Performance Testing](#79-performance-testing)
    - [7.9.1 Benchmark Tests](#791-benchmark-tests)
    - [7.9.2 Load Testing](#792-load-testing)
  - [7.10 Contract Testing (Spec Validation)](#710-contract-testing-spec-validation)
    - [7.10.1 Spec Kit Contracts](#7101-spec-kit-contracts)
    - [7.10.2 OpenSpec Contracts](#7102-openspec-contracts)
  - [7.11 Monitoring and Alerting](#711-monitoring-and-alerting)
    - [7.11.1 Test Suite Metrics](#7111-test-suite-metrics)
    - [7.11.2 Production Monitoring](#7112-production-monitoring)
  - [7.12 Quick Reference: Test Command Cheatsheet](#712-quick-reference-test-command-cheatsheet)
  - [7.13 Anti-Patterns to Avoid](#713-anti-patterns-to-avoid)
    - [7.13.1 Testing Anti-Patterns](#7131-testing-anti-patterns)
    - [7.13.2 Test Data Anti-Patterns](#7132-test-data-anti-patterns)
  - [7.14 Exceptions Process](#714-exceptions-process)
  - [7.15 Enforcement](#715-enforcement)
