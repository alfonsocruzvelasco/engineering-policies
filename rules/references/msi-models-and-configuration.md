...
- STATUS: EXCLUDED FROM ROUTING. Chinese-hosted model endpoints are prohibited across all use cases, not limited to safety-critical AV contexts. See `security-policy.md` §14.6.9.
