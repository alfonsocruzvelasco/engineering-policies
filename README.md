...
- **`rules/references/`**
  *Reference documentation and theoretical foundations*
  ...
  - `claude-skills-definiton-use-cases-and-limitations.md` — Claude Skills: definition, use cases, and limitations (architectural shift from ephemeral prompts to persistent procedural workflows, vendor lock-in considerations, governance gaps, paradigm shift implications)
