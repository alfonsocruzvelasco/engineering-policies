# Prompt Theory for CV
<a id="index"></a>

**Purpose:** This file is the **deep reference manual** (the “why” and “how”).  
For operational boundaries (“must/never/always”), see: `ai-constraint-usage-policy.md`.

---

## Index (Quick Navigation)

### Most used sections (fast access)
1. [Key Takeaways](#key-takeaways)
2. [Battle-Tested Prompt Patterns](#part-3-battle-tested-prompt-patterns)
3. [Implementation Framework](#part-4-implementation-framework)
4. [Production Deployment](#part-5-production-deployment)
5. [Tools & Platforms](#part-6-prompt-engineering-tools-and-platforms)

---

### Full Table of Contents

- [Part 1) Tokenization & Embeddings Fundamentals](#part-1-tokenization-and-embeddings-fundamentals)
- [Part 2) Prompt Engineering Theory & Research](#part-2-prompt-engineering-theory-and-research)
...
- [Part 6) Prompt Engineering Tools & Platforms](#part-6-prompt-engineering-tools-and-platforms)
- [Part 7) Official Resources & References](#part-7-official-resources-and-references)
- [Part 8) Quick Reference](#part-8-quick-reference)

---

<details>
<summary><strong>Collapsed TOC (Parts 1–8)</strong></summary>
...
#### Prompt Engineering
- **Fano’s Inequality:** hallucination becomes inevitable when prompts are ambiguous (high H(X|Y))
- Three levers: reduce output space (M), reduce ambiguity (H), design for uncertainty floor
- CoVe + Step-Back prompting are top hallucination reducers
- RAG is gold standard for factual accuracy
- Structured outputs (XML/JSON) reduce ambiguity and shrink output space
- Testing & measurement are non-negotiable
- Treat prompts as compiled artifacts with architectural constraints
- Cognitive Verifier: reduce ambiguity via clarifying questions

#### Model Selection
- Claude: best with XML + structure + context management
- GPT: agentic strengths, function calling, clean markdown delimiters

#### Production
- Tiered routing (fast/balanced/strict)
- Prompt version control
- Evaluation infrastructure early
- Token cost vs reliability is a design trade-off
- Track official docs (changes frequently)
